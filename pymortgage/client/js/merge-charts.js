...
function visualizeIt(){
    ...
    var twentyyr_URL =  "http://localhost:8080/api/d3/amort?r=.0425&P=245000&n=360&t=1836&i=1056&af=2&ac=.01&lc=.06";
    d3.json(twentyyr_URL, function(error, data) {
        if (error) return console.warn(error);
        twentyyr_data = data;

        var twentyyr_extra_URL =  "http://localhost:8080/api/d3/amort?r=.0425&P=245000&n=360&t=1836&i=1056&af=2&ac=.01&lc=.06&e=275";
